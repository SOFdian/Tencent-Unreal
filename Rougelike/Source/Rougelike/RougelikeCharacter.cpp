...
void ARougelikeCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ARougelikeCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ARougelikeCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &ARougelikeCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ARougelikeCharacter::LookUpAtRate);
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ARougelikeCharacter::OnResetVR);
}


void ARougelikeCharacter::OnResetVR()
{
	// If Rougelike is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Rougelike.Build.cs is not automatically propagated
